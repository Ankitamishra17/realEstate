...
//             {/* Tablet-only Social Icons (hidden on mobile & desktop) */}
//             <div className="hidden md:flex xl:hidden items-center gap-2 shrink-0">
//               <h2 className="text-[#0f2645] text-2xl font- font-bold mr-6 "
...
//                   className="flex items-center justify-center w-8 h-8 rounded-full border border-[#0f2645]/15 text-[#0f2645] hover:bg-[#0f2645] hover:text-white transition-all duration-300 text-sm"
//                 >
//                   {social.icon}
//                 </a>
//               ))}
...
export default function Navbar() {
  ...
  return (
    <>
      {/* Top Info Bar — now sticky/fixed, visible on all devices */}
      <div className="fixed top-0 left-0 right-0 z-[60] h-9 bg-[#0f2645] text-white text-[11px] sm:text-xs flex items-center justify-between gap-3 px-4 sm:px-6 lg:px-8 border-b border-[#af7323]/30">
        <div className="flex items-center gap-3 sm:gap-6 min-w-0 overflow-hidden">
          <span className="flex items-center gap-1.5 text-[#af7323] shrink-0">
            <RiPhoneLine className="shrink-0" />
        ...
        <div className="flex items-center gap-1.5 text-[#af7323] shrink-0 whitespace-nowrap">
          {" "}
          <RiMapPinLine className="shrink-0" />
          <span className="text-white text-[10px] whitespace-nowrap">
      ...
      {/* Main Navbar — fixed, sits right below the top info bar */}
      <nav
