    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M3 17.25l5.25-5.25 4.5 4.5L21 8.25M21 8.25H15m6 0v6"
        />
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M3 21h18M5.25 21V9.75A1.5 1.5 0 016.75 8.25h2.25A1.5 1.5 0 0110.5 9.75V21M13.5 21V5.25a1.5 1.5 0 011.5-1.5h1.5a1.5 1.5 0 011.5 1.5V21M8.25 12h.008M8.25 15h.008M16.5 9h.008M16.5 12h.008M16.5 15h.008"
        />
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M16.5 18.75h-9M12 18.75v-4.5m0 0a6.75 6.75 0 006.75-6.75V4.5h-1.5m-5.25 9.75a6.75 6.75 0 01-6.75-6.75V4.5h1.5m9 0H7.5m9 0V3H7.5v1.5m0 0H4.875A1.125 1.125 0 003.75 5.625v.75c0 2.07 1.68 3.75 3.75 3.75M16.125 4.5H19.125c.621 0 1.125.504 1.125 1.125v.75c0 2.07-1.68 3.75-3.75 3.75"
        />
      </svg>
    ),
  },
...
const styles = `
  ...
  /* Dark gradient overlay so white hero text stays readable
     regardless of how light/dark the underlying image is */
  .hero-section::before {
    content: "";
    position: absolute;
    inset: 0;
          ...
          <div className="hero-inner">
            <div className="hero-grid">
              ...
              <Fade className="hero-text-col mt-16">
                ...
                >
                  Inspired by the Sanskrit word <em>Avyaya</em> — eternal,
                  enduring, everlasting — we build spaces that stand the test of
                  time and create lasting value for communities.
                </p>
                ...
                <Fade key={s.label} delay={i * 60} style={{ height: "100%" }}>
                  <div
                    style={{
                      background: "#fff",
                      padding:
                        "clamp(1.1rem,3vw,2rem) clamp(0.75rem,2vw,1.5rem)",
                      textAlign: "center",
                      height: "100%",
                      display: "flex",
                      flexDirection: "column",
                  ...
                  >
                    <p
                      style={{
                        fontSize: "clamp(1.15rem,4.5vw,2.4rem)",
                        fontWeight: 800,
                        color: "#12243d",
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            <div className="story-grid">
              <Fade from="left">
                <div className="story-collage">
                  ...
                  <div className="story-quote-box">
                    ...
                    >
                      "Real estate is more than buildings — it is about creating
                      a legacy."
                    </p>
                  </div>
                </div>
              ...
              <Fade delay={150}>
                ...
                >
                  avyaya developer was founded with a singular conviction: that
                  real estate development in India deserved the same rigour,
                  vision, and integrity that the world's finest developers bring
                  to their work.
                </p>
                <p
                  style={{
                ...
                >
                  Our mission is to transform land into thriving destinations
                  through innovative design, superior construction, and
                ...
                >
                  ...
                  >
                    To become a trusted and leading real estate developer known
                    for sustainable, innovative, and value-driven developments.
                  </p>
                </div>
              </Fade>
            </div>
              ...
              {[
                {
                  ...
                  d: "Uncompromising standards in every project we deliver.",
                },
                {
                  n: "02",
                  t: "Sustainable Communities",
                  d: "Future-ready developments built with the planet in mind.",
                },
                {
                  n: "03",
                  t: "Trust & Transparency",
                  d: "Long-term relationships built on honesty, always.",
                },
                {
                  n: "04",
                  t: "Stakeholder Value",
                  d: "Maximising returns for customers, partners, and investors.",
                },
                {
                  n: "05",
                  t: "Social Impact",
                  d: "Contributing positively to economic and community growth.",
                },
              ].map((p, i) => (
                <Fade key={p.n} delay={i * 80}>
                  <div
                    style={{
                      ...
                      borderRadius: 2,
                      padding:
                        "clamp(1.25rem,2.5vw,1.75rem) clamp(1rem,2vw,1.25rem)",
                      textAlign: "center",
                      height: "100%",
                    }}
                  >
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            <div className="values-grid">
              <Fade from="left">
                ...
                >
                  Our values aren't aspirational posters on a wall. They are the
                  operating principles behind how we acquire land, design
                  projects, manage construction, and serve our customers.
                </p>
                <img
                  src="https://images.unsplash.com/photo-1560472355-536de3962603?w=500&q=80"
                  alt="Team meeting"
                  ...
                  <Fade key={v.title} delay={i * 70} from="right">
                    <div
                      style={{
                        ...
                        borderRadius: 2,
                        padding:
                          "clamp(1rem,2vw,1.4rem) clamp(1rem,2vw,1.5rem)",
                      }}
                    >
                      <span
                        style={{
                ...
                <div className="whyus-img-wrap">
                  <img
                    ...
                    style={{
                      width: "100%",
                      borderRadius: 2,
                      boxShadow: "0 16px 56px rgba(18,36,61,0.13)",
                      display: "block",
                    }}
                  />
                  <div className="whyus-badge">
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            <Fade>
              ...
              >
                ...
                >
                  A journey built on excellence, trust, and an unwavering
                    ...
                    >
                      <div
                        style={{
                          ...
                          justifyContent: "center",
                          marginBottom: "1.1rem",
                          boxShadow: "0 4px 20px rgba(18,36,61,0.08)",
                          flexShrink: 0,
                        }}
                      >
                        <div
                      ...
                      <div
                        style={{
                          ...
                          width: 28,
                          height: 2,
                          background: "rgba(184,137,46,0.4)",
                        }}
                      />
                    </div>
                  </Fade>
        ...
        >
          ...
          >
            <Fade>
              ...
              >
                At avyaya developer, we believe real estate is more than
                buildings — it is about creating communities, nurturing dreams,
                and building a legacy that lasts for generations.
              </p>
              <div
                style={{
                  display: "flex",
